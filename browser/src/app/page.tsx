        ...
        <div className="flex flex-col flex-wrap justify-center items-center mt-10 gap-10">
          <div>
            ...
            <input
              ...
              className="mb-2 border text-sm rounded-lg block w-[160px] py-3 px-5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500 focus-visible:outline-none"
              placeholder="100"
              required
            />
          </div>
          <button
            ...
            className="cursor-pointer transition-colors duration-150 py-2 px-5 text-lg font-medium rounded-md bg-blue-700 hover:bg-blue-800"
          >
            Run functions
          </button>
        </div>
